...
PROGRAM MSD_LAMMPS
  ...
  INTEGER::I,J,K, INITIAL_DUMP_HEADER, NO_ATOM_TRACK, NATOM, ISTAT,&
           ...
           REF_COUNT, TIME_COUNT, ATOM_START
  ...
  END DO
  write(35,*) k 
  DO I = 1, ATOM_START ! REFERENCE
  	READ(31,*) !RAN_I1,RAN_I2, X, Y, Z 
  END DO 
  DO J = 1, NO_ATOM_TRACK
    READ(31,*) RAN_I1,RAN_I2, X, Y, Z   
		...
		RZ_O(J) = Z*BOXZ
	END DO
  DO I = ATOM_START+NO_ATOM_TRACK+1, NATOM
    READ(31,*) !
  END DO 
